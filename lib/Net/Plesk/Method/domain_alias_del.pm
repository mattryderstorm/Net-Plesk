package Net::Plesk::Method::domain_alias_del;
...
sub make_aliases {
  ...
  my $aliases = ref $args{domain} ? $args{domain} : [ $args{domain} ];

  return map { $self->defined_element( name => $_ ) } @$aliases;
}
